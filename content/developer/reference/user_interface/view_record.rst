...
.. _reference/view_record/structure:
...
- :ref:`Search <reference/user_interface/views/search>` ->
  apply filters and perform searches (the result are displayed in the current view list, kanban...)
- :ref:`Kanban <reference/user_interface/views/kanban>` ->
  displays records as "cards" configurable as a small template
- :ref:`Qweb <reference/user_interface/views/qweb>` ->
  templating of reporting, website...
- :ref:`Graph <reference/user_interface/views/graph>` ->
  visualize aggregations over a number of records or record groups
- :ref:`Pivot <reference/user_interface/views/pivot>` ->
  display aggregations as a `pivot table`_
- :ref:`Calendar <reference/user_interface/views/calendar>` ->
...
:arch:
  ...
  The description of the view layout depending on :ref:`view type <user_interface/views>`
...
:priority:
  ...
  inheritance <reference/view_record/inheritance>`. When a view is requested
...
:mode:
  ...
  **primary**
  ...
  derived model. Otherwise the :ref:`view matching <reference/view_record/inheritance/view-matching>`
  rules won't apply.
...
The two following :ref:`view fields <reference/view_record/fields>` `inherit_id` and
...
.. _reference/view_record/inheritance/view-matching:
